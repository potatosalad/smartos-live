...
exports.waitForZoneState = function (payload, state, options, callback)
{
    ...
    watcher = watchZoneTransitions(payload, handler, log, callback);
...
//
function watchZoneTransitions(vmobj, handler, log, callback) {
    var buffer = '';
    var chunks;
    var cleanup;
    var watcher;
    ...
    watcher.stdout.on('data', function (data) {
        ...
        while (chunks.length > 1) {
            ...
            if (obj === prev_msg) {
                ...
                log.debug('zoneevent said: ' + JSON.stringify(obj));
                handler(obj);
            }
        }
        buffer = chunks.pop();
    ...
    watcher.on('exit', function (code) {
        log.error('zoneevent watcher ' + watcher_pid + ' exited: ',
            JSON.stringify(code));
        cleanup();
